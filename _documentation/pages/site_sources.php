Скрипты, библиотеки и стили подключае функцией html_sources()<br>
<br>
...
<ul>
	...
	<li>jquery_uploader - загрзука файлов нтмл5</li>
...
<pre>&lt;?=html_sources('return','css_reset css_common jquery')?></pre>
	...
	<li>сибираем скрипты в группу footer без вывода на экран
...
таким образом мы можем подключать любые скрипты в шаблонах, не боятся что один скрипт будет подклчен два раза и выводить все сразу в шаблоне либо в подвале страницы